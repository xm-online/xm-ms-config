...
public class ConfigurationServiceUnitTest {
    ...
    @Mock
    private MemoryConfigStorage configProxyRepository;
    @Mock
...
//
//        Map<String, Configuration> actual = configurationService.findTenantConfigurations(List.of(firstPath, secondPath), false);
//
...
//
//        Map<String, Configuration> actual = configurationService.findTenantConfigurations(List.of(), true);
//
...
//        Map<String, Configuration> actual = configurationService.findTenantConfigurations(Collections.emptyList(), false);
//
